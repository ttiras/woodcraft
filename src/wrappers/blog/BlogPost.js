  ...
  return (
    <Fragment>
      <Helmet>
        ...
        <meta
          name='description'
          content={blog.title + " " + blog.quote + " " + blog.p3}
        />
        <meta
          property='og:url'
          content={`https://micota.com.tr/post/${blog.id}`}
        />
        ...
        <meta
          property='og:image'
          itemprop='image'
          content={`https://firebasestorage.googleapis.com/v0/b/woodcraft-auth-41aa7.appspot.com/o/blog%2F${blog.img1}.jpeg?alt=media`}
        />
