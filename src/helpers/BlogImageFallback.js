...
const BlogImgFallback = ({
  ...
  return (
    <picture>
      ...
      <img src={`https://firebasestorage.googleapis.com/v0/b/woodcraft-auth-41aa7.appspot.com/o/blog%2F${path}.jpeg?alt=media`} {...delegated} alt={name + 'kahve çay sunumu ahşap yuvarlak tepsi ve supla'}/>
    </picture>
  );
};
