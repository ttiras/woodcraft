...
export default function ProductsList() {
  ...
  return (
    ...
    <div className='shop-list-content'>
      ...
      <h3 className='cart-page-title ml-5'><u>Tüm Ürünler</u></h3></div>
      <div className='col-xl-4 col-sm-6 shop-list-btn btn-hover'><button className='active order-btn newProduct' onClick={()=>setNewProductModalShow(true)}>
                      Yeni Ürün Ekle
                    </button></div>
                ...
                <div className='rating-review d-block'>
                  {product.category.map((category) => (
                    ...
                    >
                      ...
                      <div>
                        <span>
                          {"category: " + category.category.category + " " + category.category.category_id }
                        </span>
...
{product.tag.map((tag) => (
                  ...
                  <span className='redPaid'>{product.price} TL %{product.discount} </span>
                ...
                <div className='shop-list-actions d-flex align-items-center'>
                  <div className='shop-list-btn btn-hover'>
                    <button id='add' value={product.id} className='active order-btn' onClick={(e)=>handleStockModal(e)}>
                      Stoğa Ek Yap
                    </button>
                  </div>
                  <div className='shop-list-btn btn-hover ml-2'>
                    <button id='extract' value={product.id} className='active order-btn' onClick={(e)=>handleStockModal(e)}>
                      Stoktan Çıkart
                    </button>
                  </div>
                  <div className='shop-list-btn btn-hover ml-2'>
